 ...
 * Run: node backend/database/data/seedExhaustiveBeautifulPart1.js
 */

const db = require('../../src/config/db');
const runMigration = require('../migrations/migrate');

async function seedExhaustiveBeautifulPart1() {
...
> **Question 1. Her silver locks were scattered untidily over her pale, **puckered** face:**
> - a) graceful  b) fresh  c) smoothed  **d) wrinkled**

> **Question 2. It is the **efficiency** rather than the inefficiency of human memory that compels my wonder:**
> - a) irritation  b) inability  c) inferiority  **d) ability**

> **Question 3. We have to re-call the struggles of the past and realize the **perils** and possibilities:**
> - a) safeties  **b) dangers**  c) securities  d) certainty


##### ✏️ 20 Practice Questions (with Answers):
01. She had been old and **wrinkled** for the twenty years
   > 💡 **Answer**: **b) crumpled**

02. We treated it like the **fables** of the prophets
   > 💡 **Answer**: **b) stories**

03. theories with a special stamp, but only reiteratesome of the cardinal principles **enunciated**
   > 💡 **Answer**: **d) spoke clearly**

04. The greatest disadvantage for me was my loss of **appetite**
   > 💡 **Answer**: **d) hunger**

05. They consoled me and **lauded** me on the silver win
   > 💡 **Answer**: **b) appreciated**

06. As they recall their **exploits** or their errors
   > 💡 **Answer**: **d) daring acts**

07. I ate enough to **sate**
   > 💡 **Answer**: **b) satisfy**

08. She **hobbled** about the house in spotless
   > 💡 **Answer**: **a) staggered**

09. During the monarchical or **feudal** days, Universities had to train scholars
   > 💡 **Answer**: **a) old-fashioned**

10. Her silver locks were **scattered**
   > 💡 **Answer**: **a) disordered**

11. A fourth was **torpedoed** in the War
   > 💡 **Answer**: **a) abolished**

12. words of praise and **adulation** were showered on me
   > 💡 **Answer**: **b) appreciation**

13. He **persuaded** me to look in at the sale-room
   > 💡 **Answer**: **c) convinced**

14. I am always **reluctant** to trust a departing visitor to post an important letter
   > 💡 **Answer**: **d) unwilling**

15. So I pulled on it and **yanked** at it, with grunts and frowns and increasing consternation
   > 💡 **Answer**: **a) jerked**

16. do such small **prosaic** things as take the ball
   > 💡 **Answer**: **a) dull**

17. So **glibly** about 'note of hand only' really mean it
   > 💡 **Answer**: **c) smoothly**

18. yanked at it, with grunts and frowns and increasing **consternation**
   > 💡 **Answer**: **c) worry**

19. I had **gashed** my finger on the zip and was shedding blood
   > 💡 **Answer**: **d) cut**

20. I do claim to represent him in all his **ruggedness**
   > 💡 **Answer**: **a) strength**
...
#### 🔄 Prose 1 to 6 Antonyms Master Table

| English Word | தமிழ் விளக்கம் | Antonym / Opposite | தமிழ் எதிர்ச்சொல் |
| :--- | :--- | :--- | :--- |
| **wrinkled** | சுருக்கம் விழுந்த | **smooth, unwrinkled** | மென்மையான |
| **pretty** | கவர்ச்சியான | **ugly** | அசிங்கமான |
| **absurd** | பொருத்தமற்ற | **logical** | சரியான |
| **undignified** | தரமற்ற | **honoured, respected** | மரியாதைக்குரிய |
| **scattered** | சிதறிய | **gathered** | சேகரிக்கப்பட்ட |
| **inaudible** | கேட்க இயலாத | **audible, heard** | கேட்கக் கூடிய |
| **expanse** | பரந்த | **narrow** | குறுகிய |
| **serenity** | அமைதியான | **agitation** | கலவரமான |
| **contentment** | திருப்தி | **greediness** | பேராசை |
| **monotonous** | சலிப்பூட்டும் | **interesting** | ஆர்வமூட்டும் |
| **plastered** | ஈரமான | **dried** | காய்ந்த |
| **attached** | இணைக்கப்பட்ட | **detached** | பிரித்தெடுக்கப்பட்ட |
| **taught** | சொல்லித்தந்த | **learnt** | கற்றுக்கொண்டுவிட்ட |
| **creating** | உருவாக்குதல் | **destroying** | அழித்தல் |
| **shooed** | விரட்டப்பட்ட | **pulled** | இழுக்கப்பட்ட |
| **upset** | விரக்தி | **happy** | மகிழ்ச்சி |
| **physical** | உடல் தன்மை | **mental** | மனத்தன்மை |
| **mild** | லேசான | **severe** | கடுமையான |
| **omitted** | விடுபட்ட | **included, agreed, accepted** | சேர்க்கப்பட்ட |
| **amateur** | - | **professional** | - |
| **compulsory** | - | **voluntary** | - |
| **traditional** | - | **modern** | - |
| **expensive** | - | **cheap** | - |
| **prosperous** | - | **poor** | - |
| **exasperation** | - | **calmness** | - |

##### 🏛️ Government Exam Questions (MDL-18):
> **Question 1. The other teams had already completed their weight in, which is **compulsory** for all players:**
> - a) required  b) obligatory  **c) voluntary**  d) compulsion

> **Question 2. The staff looked so **prosperous** and unsympathetic:**
> - a) rich  b) wealthy  **c) poor**  d) luxurious

> **Question 3. It was at this point that my wife looked at me with an expression of wonder - not anger or **exasperation**:**
> - a) irritation  **b) calmness**  c) vexation  d) annoyance


##### ✏️ 20 Practice Questions (with Answers):
01. yet I have **accumulated** only about 212 air miles
   > 💡 **Answer**: **b) scattered**

02. She had once been young and **pretty**
   > 💡 **Answer**: **a) ugly**

03. the thought was almost **revolting**
   > 💡 **Answer**: **d) pleasing**

04. She said her morning prayer in a **monotonous**
   > 💡 **Answer**: **b) interesting**

05. her sparrows whom she fed longer and with frivolous **rebukes**
   > 💡 **Answer**: **a) blessing**

06. I was presented with a **traditional** shawl
   > 💡 **Answer**: **a) modern**

07. They were content to work in **secluded** spheres, far from the din
   > 💡 **Answer**: **c) public**

08. How **expensive** things were in America
   > 💡 **Answer**: **d) cheap**

09. With this **princely** sum, and a little more that had been collected
   > 💡 **Answer**: **d) few**

10. I set to **pondering** on the problem what to do next
   > 💡 **Answer**: **c) forgetting**

11. The people were **enormously** nice too
   > 💡 **Answer**: **c) tiny**

12. from remembering to do such small **prosaic** things as take the ball
   > 💡 **Answer**: **a) interesting**

13. She arrived home, anticipating with angry relish the white face and **quivering** lips
   > 💡 **Answer**: **d) steady**

14. therefore has no time to remember the **mediocre**
   > 💡 **Answer**: **b) special**

15. They were selling Barbizon pictures, and getting **tremendous** sums for each
   > 💡 **Answer**: **a) tiny**

16. You may find self-seekers **enthroned** and the patient worker decried
   > 💡 **Answer**: **c) dethroned**

17. I could have **embraced** him and wept for joy
   > 💡 **Answer**: **b) released**

18. lidless tin of tobacco rolled **crazily** across the concourse
   > 💡 **Answer**: **d) calmly**

19. with grunts and **frowns** and increasing consternation
   > 💡 **Answer**: **c) grins**

20. As **inheritors** of that rich legacy, you are best suited
   > 💡 **Answer**: **a) predecessors**`
...
##### ✏️ 10 Practice Questions (with Answers):
01. Prefix for **honest**
   > 💡 **Answer**: **dis** (dishonest)

02. Prefix for **fortunate**
   > 💡 **Answer**: **un** (unfortunate)

03. Prefix for **respect**
   > 💡 **Answer**: **dis** (disrespect)

04. Prefix for **legitimate**
   > 💡 **Answer**: **il** (illegitimate)

05. Prefix for **beatable**
   > 💡 **Answer**: **un** (unbeatable)

06. Prefix for **agree**
   > 💡 **Answer**: **dis** (disagree)

07. Prefix for **active**
   > 💡 **Answer**: **in** (inactive)

08. Prefix for **finite**
   > 💡 **Answer**: **in** (infinite)

09. Prefix for **obedient**
   > 💡 **Answer**: **dis** (disobedient)

10. Prefix for **necessary**
...
| # | Word | Definition |
| :---: | :--- | :--- |
| **01** | **patriotism** | love of country and willingness to sacrifice for it |
| **02** | **nationalism** | doctrine that your country\'s interests are superior |
| **03** | **egocentrism** | concern for your own interests and welfare |
| **04** | **feminism** | doctrine advocating equal rights for women |
| **05** | **criticism** | serious examination and judgment of something |
| **06** | **amateurism** | participating in sports as a hobby rather than for money |
| **07** | **barbarism** | brutal barbarous, savage act |
| **08** | **idealism** | belief that the best possible concepts should be pursued |
| **09** | **heroism** | exceptional courage when facing danger |
...
| :--- | :--- |
| **bear with** | tolerate |
| **break down** | repair / stop working |
| **call off** | cancel |
| **call on** | meet, visit |
| **carry out** | perform |
| **deal with** | manage |
...
| :---: | :--- | :--- |
| **01** | **viva voce** | a spoken examination |
| **02** | **bonafide** | genuine |
| **03** | **sine die** | without a date being fixed, indefinitely |
| **04** | **resume** | a summary |
| **05** | **in toto** | totally |
| **06** | **rapport** | a close relationship |
| **07** | **liaison** | coordination of activities |
| **08** | **bon voyage** | saying goodbye |
| **09** | **postmortem** | after death |
...
| Direct / Taboo Word | Polite Euphemism |
| :--- | :--- |
| **blind** | visually challenged |
| **handicapped/disabled** | differently-abled |
| **disabled** | a special child |
...
module.exports = seedExhaustiveBeautifulPart1;
